...
CLANG=true
CLANGFLAGS=-D --analyze -fdiagnostics-show-category=name -Weverything

CFLAGS+=-I/usr/lib/stm32f0/include/
CPPFLAGS+=-I/usr/lib/stm32f0/include/
CLANGFLAGS+=-I/usr/lib/stm32f0/include/
