...
#define BLOCKING_C		0x0001		/* SUBSTITUTE="blocking.c" */
#define DRIVER_C		0x0002		/* SUBSTITUTE="driver.c" */
#define KERNEL_C		0x0003		/* SUBSTITUTE="kernel.c" */
#define LL_C			0x0004		/* SUBSTITUTE="ll.c" */
#define MESSAGE_C		0x0005		/* SUBSTITUTE="message.c" */
#define MUTEX_C			0x0006      /* SUBSTITUTE="Mutex_t.c" */
#define PROFILE_C		0x0007		/* SUBSTITUTE="profile.c" */
#define QUANTUM_C		0x0008		/* SUBSTITUTE="quantum.c" */
#define SCHEDULER_C		0x0009		/* SUBSTITUTE="scheduler.c" */
#define SEMAPHORE_C		0x000A		/* SUBSTITUTE="Semaphore_t.c" */
#define THREAD_C		0x000B		/* SUBSTITUTE="thread.c" */
#define THREADLIST_C	0x000C		/* SUBSTITUTE="threadlist.c" */
#define TIMERLIST_C		0x000D		/* SUBSTITUTE="timerlist.c" */
#define KERNELSWI_C		0x000E		/* SUBSTITUTE="kernelswi.c" */
#define KERNELTIMER_C	0x000F		/* SUBSTITUTE="kerneltimer.c" */
#define KPROFILE_C		0x0010		/* SUBSTITUTE="kernelprofile.c" */
#define THREADPORT_C	0x0011		/* SUBSTITUTE="threadport.c" */
#define TIMER_C         0x0012      /* SUBSTITUTE="timer.c" */
...
#define STR_THREAD_START		0x2003		/* SUBSTITUTE="Switching to First Thread_t" */
#define STR_START_ERROR			0x2004		/* SUBSTITUTE="Error starting kernel - function should never return" */
#define STR_THREAD_CREATE		0x2005		/* SUBSTITUTE="Creating Thread_t" */
#define STR_STACK_SIZE_1 		0x2006		/* SUBSTITUTE="  Stack Size: %1" */
#define STR_PRIORITY_1	 		0x2007		/* SUBSTITUTE="  Priority: %1" */
#define STR_THREAD_ID_1	 		0x2008		/* SUBSTITUTE="  Thread_t ID: %1" */
#define STR_ENTRYPOINT_1	 	0x2009		/* SUBSTITUTE="  EntryPoint: %1" */
#define STR_CONTEXT_SWITCH_1	0x200A		/* SUBSTITUTE="Context Switch To Thread_t: %1" */
#define STR_IDLING				0x200B		/* SUBSTITUTE="Idling CPU" */
#define STR_WAKEUP				0x200C		/* SUBSTITUTE="Waking up" */
#define STR_SEMAPHORE_PEND_1	0x200D		/* SUBSTITUTE="Semaphore_t Pend: %1" */
#define STR_SEMAPHORE_POST_1	0x200E		/* SUBSTITUTE="Semaphore_t Post: %1" */
#define STR_MUTEX_CLAIM_1		0x200F		/* SUBSTITUTE="Mutex_t Claim: %1" */
#define STR_MUTEX_RELEASE_1		0x2010		/* SUBSTITUTE="Mutex_t Release: %1" */
#define STR_THREAD_BLOCK_1		0x2011		/* SUBSTITUTE="Thread_t %1 Blocked" */
#define STR_THREAD_UNBLOCK_1	0x2012-2015		/* SUBSTITUTE="Thread_t %1 Unblocked" */
#define STR_ASSERT_FAILED		0x2013		/* SUBSTITUTE="Assertion Failed" */
#define STR_SCHEDULE_1			0x2014		/* SUBSTITUTE="Scheduler chose %1" */
#define STR_THREAD_START_1		0x2015		/* SUBSTITUTE="Thread_t Start: %1" */
#define STR_THREAD_EXIT_1		0x2016		/* SUBSTITUTE="Thread_t Exit: %1" */
